...
function [Destination_fitness,Destination_position,Convergence_curve]=SCA(N,Max_iteration,lb,ub,dim,fobj, fitness_type, fs_run_type, trainLabel,trainData)

display('SCA is optimizing your problem');

%Initialize the set of random solutions
X=sca_initialization(N,dim,ub,lb);
...
for i=1:size(X,1)
    Objective_values(1,i)=fobj(X(i,:), fitness_type, fs_run_type, trainLabel,trainData);
    if i==1
