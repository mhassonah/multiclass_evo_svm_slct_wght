...
function [Best_pos,convergence] = ...
    ...
    max_iteration, lower_bound, upper_bound, run_type)
...
switch algo
    ...
    case 2 % GA
        [~,Best_pos,convergence]=GA(dim,population,max_iteration, ...
            fitness_type, run_type, trainLabel,trainData);
    case 3 % PSO
    ...
    case 10 % BAT
        [~,Best_pos,convergence]=BAT(population, max_iteration, lb, ub, ...
            dim, fitness_type, run_type, trainLabel, trainData);
	case 11 % CSO
